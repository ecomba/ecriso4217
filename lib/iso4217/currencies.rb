module ISO4217
  ...
  CURRENCIES = [
    ALBANIAN_LEK=                   Currency.new(:ALL, "Lek", 'Lek'),
    AMERICAN_DOLLAR=                Currency.new(:USD, DOLLAR_SIGN, 'US dollar'),
    AFGHANI=                        Currency.new(:AFN, "U+060b", 'Afghani'),
    ALGERIAN_DINAR=                 Currency.new(:DZD, "DA", 'Algerian dinar'),
    ANGOLAN_KWANZA=                 Currency.new(:AOA, "Kz", 'Angolan kwanza'),
    ARGENTINA_PESOS=                Currency.new(:ARS, "U+0024", 'Argentine peso'),
    ARMENIAN_DRAM=                  Currency.new(:AMD, "U+0534", 'Armenian dram'),
    ARUBAN_FLORIN=                  Currency.new(:AWG, "Afl", 'Aruban florin'),
    AUSTRALIAN_DOLLAR=              Currency.new(:AUD, DOLLAR_SIGN, 'Australian dollar'),
    AZERBAIJANIAN_MANAT=            Currency.new(:AZN, "man", 'Azerbaijani manat'),
    BAHAMAS_DOLLAR=                 Currency.new(:BSD, DOLLAR_SIGN, 'Bahamian dollar'),
    BAHRAINI_DINAR=                 Currency.new(:BHD, "BD", 'Bahraini dinar'),
    BANGLADESHI_TAKA=               Currency.new(:BDT, "U+09F3", 'Bangladeshi taka'),
    ...
    HUNGARY_FORINT=                 Currency.new(:HUF, "U+0046U+0074", 'Forint'),
